...
def main():
    ...
    while True:
        ...
        print(f'{state.if_id.branch_adder = }')
        ...
        print(f'{branch_adder = }')
        print(f'{next_pc = }')
        print(f'{branch_predictor.corrected_pc = }')
        print(f'{cpc_mux = }')
